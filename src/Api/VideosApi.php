...
class VideosApi
{
    ...
    {
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling VideosApi.getArticlesWithVideo, must be bigger than or equal to 1.');
        }

        if ($perPage !== null && $perPage > 1000) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling VideosApi.getArticlesWithVideo, must be smaller than or equal to 1000.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling VideosApi.getArticlesWithVideo, must be bigger than or equal to 1.');
        }
