...
class TagsApi
{
     ...
     * @param  int $perPage Page size (the number of items to return per page). (optional, default to 10)
     *
     * @throws \Bitween\DevTo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Bitween\DevTo\Model\Tag[]
     */
    public function getTags($page = 1, $perPage = 10)
    {
        list($response) = $this->getTagsWithHttpInfo($page, $perPage);
        return $response;
    }
     ...
     * @throws \Bitween\DevTo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Bitween\DevTo\Model\Tag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($page = 1, $perPage = 10)
    {
        $request = $this->getTagsRequest($page, $perPage);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Bitween\DevTo\Model\Tag[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Bitween\DevTo\Model\Tag[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Bitween\DevTo\Model\Tag[]';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsync($page = 1, $perPage = 10)
    {
        return $this->getTagsAsyncWithHttpInfo($page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($page = 1, $perPage = 10)
    {
        $returnType = '\Bitween\DevTo\Model\Tag[]';
        $request = $this->getTagsRequest($page, $perPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsRequest($page = 1, $perPage = 10)
    {
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling TagsApi.getTags, must be bigger than or equal to 1.');
        }

        if ($perPage !== null && $perPage > 1000) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling TagsApi.getTags, must be smaller than or equal to 1000.');
        }
        if ($perPage !== null && $perPage < 1) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling TagsApi.getTags, must be bigger than or equal to 1.');
        }
