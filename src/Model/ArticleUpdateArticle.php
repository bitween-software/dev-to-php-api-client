...
/**
 * ArticleUpdateArticle Class Doc Comment
 *
 * @category Class
 * @package  Bitween\DevTo
 * @author   OpenAPI Generator team
 ...
 */
class ArticleUpdateArticle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleUpdate_article';
     ...
     * Sets series
     *
     * @param string|null $series Article series name.  All articles belonging to the same series need to have the same name in this parameter.  To remove an article from a series, the `null` value can be used.
     *
     * @return self
     */
